...
for i in range(nframe_train):
    ...
    np.save(os.path.join(dir_save_train, 'image_%03d.npy' %i), image_)
...
for i in range(nframe_val):
    ...
    np.save(os.path.join(dir_save_val, 'image_%03d.npy' % i), image_)
...
for i in range(nframe_test):
    ...
    np.save(os.path.join(dir_save_test, 'image_%03d.npy' % i), image_)
